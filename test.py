...
def main():
    print("🚀 DEMO COMPLETA AVVIATA - Invio messaggi su Telegram...")
    ...
    # 2. GOL LIVE JUVENTUS -> SI VA SULL'1-0
    ...
    # 8. GOL LIVE INTER -> ADESSO SI VA SULL'1-1
    ...
    # ==============================================================================
    print("⚽️ Lotteria dei rigori nella demo...")
