...
def trova_partita_con_notifica(team_id: str):
    ...
    if partita:
        _notifica_partita_trovata_test(partita)

    return partita


# Il bot originale resta intatto: sostituiamo solo la funzione di discovery
# durante questo run, aggiungendo la notifica sul canale Test.
