...
CITY_ID = 50  # ID ufficiale del Manchester City su API-Football
...
def clean_name(name):
    annoying_words = ["AC ", "AS ", " US", " FC", "FC ", "A.C. ", "A.S. ", " Manchester ", "Manchester "]
...
def main():
    print("BOT LIVE MAN CITY AVVIATO - Monitoraggio continuo...")
    ...
    while True:
        try:
            ...
            h_short = "City" if home_id == CITY_ID else home_name
            a_short = "City" if away_id == CITY_ID else away_name
