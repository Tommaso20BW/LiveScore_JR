...
- uses official goal_graphics / portrait_graphics / stats_graphics assets, with NEC Nijmegen as opponent
...
# goal_graphics._remote_espn_team_logo() currently calls io.BytesIO without
# importing io in goal_graphics.py. The production file is left untouched.
# If FCLogo has no local NEC logo, this lets the existing ESPN fallback work.
import io as _io
try:
    import goal_graphics as _goal_graphics
except ModuleNotFoundError:
    _goal_graphics = None
if _goal_graphics is not None and not hasattr(_goal_graphics, "io"):
    _goal_graphics.io = _io
